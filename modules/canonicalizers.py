...
class CloudServiceCanonicalizer(Canonicalizer):
    """ TODO - Class DOC """
    ...
    def _tokenize_current_word(self) -> [CanonicalToken]:
        """ TODO - Function DOC """
...
class TEIFileCanonicalizer(Canonicalizer):
    """ TODO - Class DOC """
        ...
        for tei_utterance_word in current_reference_utterance.words:
            ...
            if canonical_utterance_word:
                ...
                for tei_utterance_word_event in tei_utterance_word.events:
                    canonical_utterance_word_event = CanonicalTokenEvent(type=tei_utterance_word_event.type.name)
                    # Populate properties
                    for key, value in tei_utterance_word_event.properties:
                        canonical_utterance_word_event_property = CanonicalTokenEventProperty(key=key, value=value)
...
class GoogleSTTCanonicalizer(CloudServiceCanonicalizer):
    """ TODO - Class DOC """

    class GoogleTranscriptionFileStatus(CloudServiceCanonicalizer.TranscriptionFileStatus):
        """ TODO - Class DOC """
    ...
    def _get_transcription_file_status(self, transcription_file_content: str):
        ...
        return GoogleSTTCanonicalizer.GoogleTranscriptionFileStatus(recognize_response)


class AWSTranscribeCanonicalizer(CloudServiceCanonicalizer):
    """ TODO - Class DOC """

    class AmazonTranscriptionFileStatus(CloudServiceCanonicalizer.TranscriptionFileStatus):
        """ TODO - Class DOC """
    ...
    def _get_transcription_file_status(self, transcription_file_content: str):
        ...
        return AWSTranscribeCanonicalizer.AmazonTranscriptionFileStatus(transcribe_response)

    def _is_current_word_after_reference_utterance_end(self) -> bool:
        """ TODO - Function DOC """

        current_transcription_file_status = cast(AWSTranscribeCanonicalizer.AmazonTranscriptionFileStatus,
